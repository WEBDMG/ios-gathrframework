...
open class Config:NSObject{
    ...
    /// URL to users website. Set by the user.
    public var playmeappyoutubeurl = ""
    ...
    public init?(response:NSDictionary) {
        ...
        self.blogurl = response.value(forKey: "blogurl") as! String
        self.playmeappappleid = response.value(forKey: "playmeappappleid") as! String
        self.playmeappfacebookurl = response.value(forKey: "playmeappfacebookurl") as! String
        self.playmeapphomeurl = response.value(forKey: "playmeapphomeurl") as! String
        self.playmeappid = response.value(forKey: "playmeappid") as! String
        self.playmeappinstagramurl = response.value(forKey: "playmeappinstagramurl") as! String
        self.playmeappkeywords = response.value(forKey: "playmeappkeywords") as! String
        self.playmeapplandingpageactive = response.value(forKey: "playmeapplandingpageactive") as! String
        self.playmeappname = response.value(forKey: "playmeappname") as! String
        self.playmeappnameformatted = response.value(forKey: "playmeappnameformatted") as! String
        self.playmeappstoreurl = response.value(forKey: "playmeappstoreurl") as! String
        self.playmeapptoken = response.value(forKey: "playmeapptoken") as! String
        self.playmeapptwitterurl = response.value(forKey: "playmeapptwitterurl") as! String
        self.playmeappyoutubeurl = response.value(forKey: "playmeappyoutubeurl") as! String
        self.playmetoken = response.value(forKey: "playmetoken") as! String
...
//        self.playmeappyoutubeurl = (((response.value(forKey: "config") as AnyObject).value(forKey: "playmeappyoutubeurl") as AnyObject).object(at: 0)) as! String
